<template>
  <div class="page-content">
    <h2>About</h2>
    <p>
      GA WorkersComp is an online journal covering all aspects of the Georgia Workers&rsquo; Compensation system. We provide a mixture of original and previously published articles, papers, and outlines. If you would like to be considered for online publication, query
      <a href="mailto:attorney@gaworkerscomp.com">attorney@gaworkerscomp.com</a> prior to sending any material. GA WorkersComp is a public service offered free of charge. Please read our
      <nuxt-link to="/disclaimer">Legal Disclaimer.</nuxt-link>
    </p>
